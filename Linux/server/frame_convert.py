#!/usr/bin/env python
#
# modified from the version included with libfreenect
# added conversion to JPG and horizontal flipping so 
...
def video_cv(video):
    ...
    cv.SaveImage('frame.jpg', image)
    return image


def video_pe(video):
    """Converts video frame into a JPG for streaming without BGR conversion
